...
export class IncomeService {
  ...
  fetchDefaultData(): IncomeRecord[] {
    return [
      ...
      { projectName: '项目8', signUnit: '单位G', costItem: '转存', month: '2022-11', invoiceAmount: 6000, receivedFee: 5500, paymentTime: new Date('2022-11-10'), contractDuration: '2023-2024', withdrawTime: new Date('2023-04-01'), status: '在施', taxRate: 0.06, taxNote: '无' }
    ];
  }
}
